...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || 'MEGA MD Moçambique',
    botOwner: process.env.BOT_OWNER || 'Proprietário',
    ownerNumber: process.env.OWNER_NUMBER || '258869045822',
    author: process.env.AUTHOR || 'Silva MD Seguro',
    packname: process.env.PACKNAME || 'MEGA MD PT',
    description: process.env.DESCRIPTION || 'Bot WhatsApp completo em português',
    version: '6.0.0',
    // Bot Config
    prefixes: _prefixes,
    prefix: _prefixes[0],
